...
def hazzys_turbo_decode(sys_symbols, non_sys_symbols_1, non_sys_symbols_2, trellis,
                 noise_variance, number_iterations, interleaver, L_int = None, dec_type = 'awgn'):
    """ Turbo Decoder.
...
def hazzys_g_turbo_decode(sys_symbols, non_sys_symbols_1, non_sys_symbols_2, trellis,
                 noise_variance, number_iterations, interleaver, L_int = None):
    """ Turbo Decoder.
    ...
    for iteration_count in xrange(number_iterations):
        ...
        [L_2, decoded_bits] = map_decode(sys_symbols_i, non_sys_symbols_2,
                                         trellis, noise_variance, L_int_2, 'compute')
        L_ext_2 = L_2 - L_int_2
        L_ext_2 = L_ext_2*0.9*np.exp(-0.01*np.abs(L_ext_2))
